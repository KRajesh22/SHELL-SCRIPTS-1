...
Run "Setting up Reverse proxy" "curl -f -s https://raw.githubusercontent.com/citb32x/project-setup/master/web-proxy.conf -o  /etc/httpd/conf.d/studentapp.conf"
...
Run "Start Web Service" "systemctl enable httpd; systemctl start httpd"